...
export class Simulation {
    ...
    static _lanchester_diffeq(regiment, opponent) {
        ...
        if (regiment.law === 'ln') {
            ...
            return (sizes, coef, idx) => -coef[1 - idx] * sizes[0] * sizes[1 - idx];
        }
        else if (regiment.law === 'sq') {
            return (sizes, coef, idx) => -coef[1 - idx] * sizes[1 - idx];
        }
        else {

...
def test_cavalry_unit_type():
    reg = CavalryRegiment(400, '5/5/0/0', subtype='light')
...
def test_cavalry_inherits_regiment_attributes():
    reg = CavalryRegiment(400, '5/5/1/1', subtype='heavy')
    assert reg.size == 400
...
def test_cavalry_invalid_stats_raises():
    with pytest.raises(ValueError):
        CavalryRegiment(400, 'bad/stats', subtype='light')
...
def test_cavalry_position_at_construction():
    ...
    reg = CavalryRegiment(400, '5/5/0/0', subtype='light', position=pos)
    assert reg.position == pos
...
def test_cavalry_flat_distance_to():
    a = CavalryRegiment(400, '5/5/0/0', subtype='light')
    b = CavalryRegiment(400, '5/5/0/0', subtype='light')
